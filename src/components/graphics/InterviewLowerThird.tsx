...
import type { InterviewData, GraphicsSettings } from '@/types/rally';
...
const InterviewLowerThird = ({ data, settings, onMouseDown }: Props) => {
  ...
  return (
    <div style={layoutStyle(settings, 'interviewLowerThird')} onMouseDown={onMouseDown}>
      <motion.div
...
export default InterviewLowerThird;
